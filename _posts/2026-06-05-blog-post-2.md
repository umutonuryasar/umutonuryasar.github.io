...
> **Update — August 2026:** This was written before I ran the RT-DETR distillation study. The later controlled experiments changed an important part of the interpretation below: Hungarian query matching did **not** improve the student in my setup, while a simpler index-truncation control performed better across repeated seeds. See the [technical report](/rt-detr-kd/) for the completed experiments and results.
