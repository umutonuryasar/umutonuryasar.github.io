...
.page.research-report .page__inner-wrap { width: min(100%, 880px); margin: 4.5rem auto 6rem; }
.page.research-report .page__inner-wrap > header { margin-bottom: 2.4rem; }
.page.research-report .page__title { max-width: 840px; margin: 0; font-size: clamp(2.55rem, 5vw, 4.25rem); line-height: 1.02; letter-spacing: -.055em; font-weight: 650; }
.page.research-report .page__date { margin-top: .8rem; color: var(--portfolio-muted); font-size: .78rem; }
...
@media (max-width: 720px) {
  .page.research-report .page__inner-wrap { width: auto; margin: 3rem 1rem 4.5rem; }
  .page.research-report .page__title { font-size: clamp(2.3rem, 12vw, 3.25rem); }
